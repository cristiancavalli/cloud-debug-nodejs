...
/** @const {object} the main proto file builder used to house namespaced data structures */
var builder = grpc.load({
...
var CloudDebuggerV2 = builder.google.devtools.clouddebugger.v2;  // builder.build("google.devtools.clouddebugger.v2");
/** @const {object} the builder for v1 client endpoints - used in some v2 payloads */
var DevToolsSourceV1 = builder.google.devtools.source.v1; // builder.build("google.devtools.source.v1");
...
DebugletApi.prototype.register_ = function(errorMessage, callback) {
  ...
  var projectId = that.sourceContext_.cloudRepo.repoId.projectRepoId.projectId;
  var repoName = that.sourceContext_.cloudRepo.repoId.projectRepoId.repoName;
  var revisionId = that.sourceContext_.cloudRepo.revisionId;
  ...
  var debuggee = new CloudDebuggerV2.RegisterDebuggeeRequest({
    debuggee: new CloudDebuggerV2.Debuggee({
        ...
        labels: labels,
        source_contexts: [
            new DevToolsSourceV1.SourceContext({
                cloud_repo: new DevToolsSourceV1.CloudRepoSourceContext({
                    repo_id: new DevToolsSourceV1.RepoId({
                        project_repo_id: new DevToolsSourceV1.ProjectRepoId({
